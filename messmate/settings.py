...
SECRET_KEY = "django-insecure-38%a=j50yb(te$fw*_yn1oym=l%_q=mlvifht+4&_66o5%+kc$"
...
WSGI_APPLICATION = "messmate.wsgi.application"
...
STATIC_URL = "static/"
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Folder for all static files after collectstatic
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # Directory where you store static files in development
